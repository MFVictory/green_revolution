...
class _MyHomePageState extends State<MyHomePage> {
              ...
              children: <Widget>[
                Text("Good",
                    style: TextStyle(
                        ...
                        fontSize: 50.0)),
                Text("Morning",
                style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF5B8842),
                fontSize: 50.0)),
         ...
         Container(height: 250.0,
          ...
          Padding(
            ...
            child: Container(
              height: 200.0,
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [Colors.white, Color(0xFFACBEA3)],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight),
                borderRadius: BorderRadius.circular(15.0),
                image: DecorationImage(image: AssetImage('assets/plate1.png'),
                  fit: BoxFit.contain),),
            ),
          ),
        ],
  ...
  Widget _buildListItem(String imgPath, String foodName, String price) {
    return InkWell(
      onTap: (){Navigator.of(context).push((MaterialPageRoute(builder: (context) => DetailsPage(heroTag: imgPath, foodName: foodName, foodPrice: price)
      )));
      },
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              Text("4.9", style: TextStyle(fontFamily: 'Montserrat',
                          ...
                          Text(price, style: TextStyle(fontFamily: 'Montserrat', fontWeight: FontWeight.w500,
                            color: Colors.black,
                            fontSize: 16.0),),
                        ],
                      ),
