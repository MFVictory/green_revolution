        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              ...
              Positioned(top: 50.0, left: (MediaQuery
                  .of(context)
                  .size
                  .width / 2) - 125,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[Text(widget.foodPrice,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text('$_counter', style: TextStyle(fontFamily: 'Montserrat',
                              fontSize: 20.0, color: Color(0xFF5CB238)
                          ),
                          ),
